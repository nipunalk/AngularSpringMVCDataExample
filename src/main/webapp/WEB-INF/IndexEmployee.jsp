...
<html>
  <head>  
    <title>AngularJS + Spring Data Example</title>  
  
     <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css">
    
     <link href="${resourceUrl}/static/css/app.css" rel="stylesheet">
      <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.4.4/angular.js"></script>
      <script src="${resourceUrl}/static/js/app.js"></script>
      <script src="${resourceUrl}/static/js/controller/employeeController.js"></script>
      <script src="${resourceUrl}/static/js/service/employeeService.js"></script>
  </head>
